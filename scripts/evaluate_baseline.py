...
def main():
    ...
    parser.add_argument(
        "--model", default=OPEN_CALM_TOKENIZER,
        help=f"Model name (default: {OPEN_CALM_TOKENIZER})"
    )
    parser.add_argument(
    ...
    # argsから設定を更新
    exp_config.num_docs = args.num_docs
    exp_config.tokens_per_doc = args.tokens_per_doc
    exp_config.seq_length = args.seq_length
