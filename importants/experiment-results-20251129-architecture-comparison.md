...
|--------|--------|-------------|--------------|---------------|------|------|------|----------|----------|--------|
| baseline | 6 | 768 | 1 | 7.09M | -0.4860 | 1.16×10⁸ | 0.9895 | 249.3 | 21.3% | 75.2% |
| input_tokens_2 | 6 | 768 | 2 | 10.63M | -0.4702 | 6.69×10⁷ | 0.9870 | 198.1 | 22.5% | 82.4% |
| context_dim_1152 | 6 | 1152 | 1 | 13.29M | -0.4988 | 1.58×10⁸ | 0.9963 | 246.9 | 21.4% | 71.0% |
| layers_9 | 9 | 768 | 1 | 10.64M | -0.4818 | 1.16×10⁸ | 0.9915 | 256.8 | 21.1% | 73.7% |
| **shallow_wide** | **3** | **1536** | **2** | **14.17M** | **-0.5402** | **5.95×10⁸** | 0.9770 | **197.0** | **22.9%** | 78.5% |
...
**Scaling Law**: α = -0.4860, A = 1.16×10⁸ (R² = 0.9895)
...
**Scaling Law**: α = -0.4702, A = 6.69×10⁷ (R² = 0.9870)
...
**Scaling Law**: α = -0.4988, A = 1.58×10⁸ (R² = 0.9963)
...
**Scaling Law**: α = -0.4818, A = 1.16×10⁸ (R² = 0.9915)
...
**Scaling Law**: α = -0.5402, A = 5.95×10⁸ (R² = 0.9770)
...
| Config | A値 | 解釈 |
|--------|-----|------|
| input_tokens_2 | 6.69×10⁷ | **最小** - 少データで最も有利 |
| baseline | 1.16×10⁸ | 標準 |
| layers_9 | 1.16×10⁸ | baselineと同等 |
| context_dim_1152 | 1.58×10⁸ | やや高い |
| shallow_wide | 5.95×10⁸ | **最大** - 少データでは不利だがスケーリングで逆転 |
...
| **少データ性能** | `input_tokens_2` | A = 6.69×10⁷（最小） |
