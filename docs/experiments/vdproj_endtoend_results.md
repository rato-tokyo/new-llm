...
| Model | val_ppl | Best Epoch | KV Reduction |
|-------|---------|------------|--------------|
| V-DProj (End-to-End) | **428.7** | 4 | 18.8% |
...
1. **PPLが非常に高い**: 428.7はPythia baseline (約442程度) より悪い
2. **収束が不安定**: 早期に過学習が始まる
3. **V復元と言語モデリングのトレードオフ**: 同時学習では両立が困難

## 結論

**V-DProj End-to-End学習は過学習が早く、安定した学習が困難**
