"""Test 20 tokens - confirm boundary"""
...
def main():
    print("="*70)
    print("Test 20 Tokens - Confirm Boundary")
    print("="*70)

    # Sequential
    print("\n[1/2] Sequential with 20 tokens")
    ...
    seq_passed = test_convergence(model_seq, config_seq, 20, "Sequential (trained)")
    print(f"  Result: {'✅ PASS' if seq_passed else '❌ FAIL'}")

    # Layer-wise
    print("\n[2/2] Layer-wise with 20 tokens")
    ...
    layer_passed = test_convergence(model_layer, config_layer, 20, "Layer-wise (trained)")
    print(f"  Result: {'✅ PASS' if layer_passed else '❌ FAIL'}")

    print("\n" + "="*70)
    print("Final Boundary:")
    print(f"  19 tokens: Both PASS ✅")
    print(f"  20 tokens: Sequential {'PASS ✅' if seq_passed else 'FAIL ❌'}, Layer-wise {'PASS ✅' if layer_passed else 'FAIL ❌'}")
    print("="*70)
