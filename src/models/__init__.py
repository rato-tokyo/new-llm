...
from .selective import SelectiveOutputLM, OutputGate
...
def create_model(
    ...
    *,
    ...
    Args:
        ...
        max_skip: Max consecutive skips (selective only)
    ...
    Examples:
        ...
        # Selective output model
        model = create_model("selective", max_skip=3)
