...
def create_pythia_layers(
    ...
    """標準Pythiaレイヤーのリストを作成"""
    from src.models.layers import PythiaLayer
    return [
        PythiaLayer(
...
def create_infini_pythia_layers(
    num_layers: int,
    hidden_size: int,
    num_heads: int,
    intermediate_size: int,
    ...
    """Infini-Pythiaレイヤーのリストを作成（1層目Infini + 残りPythia）"""
    from src.models.layers import InfiniLayer, PythiaLayer
...
def create_multi_memory_pythia_layers(
    num_layers: int,
    hidden_size: int,
    num_heads: int,
    intermediate_size: int,
    ...
    """Multi-Memory Pythiaレイヤーのリストを作成"""
    from src.models.layers import MultiMemoryLayer, PythiaLayer
...
def create_hierarchical_pythia_layers(
    num_layers: int,
    hidden_size: int,
    num_heads: int,
    intermediate_size: int,
    ...
    """Hierarchical Memory Pythiaレイヤーのリストを作成"""
    from src.models.layers import HierarchicalLayer, PythiaLayer
